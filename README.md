...
`mapped_reads.hdf5`: the file containing the alignment of basecalled sequence and nanopore signal generated by [taiyki workflow](https://github.com/nanoporetech/taiyaki/tree/master?tab=readme-ov-file#steps-from-fast5-files-to-basecalling).
